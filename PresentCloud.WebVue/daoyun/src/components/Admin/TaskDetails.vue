     ...
     <div class="detail" style="padding-bottom:35px;">
      ...
      <el-table-column
       ...
       <el-table-column
        ...
        width="260">
        <template slot-scope="scope">
          <!-- <router-link v-bind:to="'http://localhost/daoyunapi/public/uploads/'+scope.row.presentation">{{scope.row.presentation}}</router-link> -->
          <a :href="scope.row.presentation">{{scope.row.presentation}}</a>
        </template>
      </el-table-column>
    </el-table>
